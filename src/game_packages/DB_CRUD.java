...
class DB_CRUD implements CrudHelpers {
    public static CrudHelpers dbCrudHelpers = new DB_CRUD();
    ...
    public String userInput(Scanner sc, String toBeCollected, boolean stringOrNumber){
    ...
    public void jsonPrettyPrint(ArrayList<Territory> territories) {
    ...
    public void createTerritories() {
        ...
        while (true) {
            ...
            while (true) {
                ...
                int settlementInput = parseInt(userInput(input, "Your choice(0-4) ? : eg 1 for a village, 2 for a town, ...", false));
    ...
    public String setNOCs(Map<String, String> noc, String profession){
    ...
    public Village createVillage(Territory territory){
    ...
    public Town createTown(Territory territory) {
    ...
    public City createCity(Territory territory) {
    ...
    public Metropolis createMetropolis(Territory territory) {
    ...
    public void createBuildings(String territoryAddress, String settlementId, ArrayList<Building> buildings){
        while (true) {
